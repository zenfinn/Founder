          ...
          <div className="mb-5 flex flex-col gap-3 rounded-[1.5rem] border border-slate-200 bg-white/80 px-5 py-4 shadow-sm shadow-slate-950/5 backdrop-blur md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <button
                type="button"
                onClick={() => {
                  writeDashboardVariant("bento");
                  onSwitchBento();
                }}
                className="rounded-full border border-founder-200 px-3 py-2 text-xs font-bold text-founder-600 transition hover:bg-founder-50"
              >
                Neues Bento-Layout
              </button>
