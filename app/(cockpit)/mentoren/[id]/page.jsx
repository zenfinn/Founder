...
import { OG_IMAGE_URL, buildPageMetadata } from "@/lib/seo";
import {
  ...
  return (
    <CockpitPage>
      <div className="grid gap-6 lg:grid-cols-[1fr_360px]">
          <CockpitPanel>
            <Link href="/mentoren" className="text-sm font-bold text-[#5b8cff]">
              Zurück zu Mentoren
            </Link>
            <div className="mt-6">
