...
export function buildPageMetadata({
  ...
  const image = ogImage ?? buildOgImageUrl({ title: ogTitle ?? title.split("|")[0].trim(), subtitle: description });
...
export const PAGE_SEO = {
  ...
  community: {
    ...
    description:
      "Reselling Community, E-Commerce Netzwerk, Amazon FBA, TikTok Creator und mehr – native Gruppen mit Chat, Ressourcen und Wins für verifizierte Gründer.",
  },
  events: {
    path: "/events",
  ...
  mentoren: {
    ...
    description:
      "Mentor finden Unternehmer: Buche verifizierte Builder, Scaler und Elite als 1:1 Coaches. Transparente Stundensätze und Stripe-Buchung.",
  },
  leaderboard: {
    path: "/leaderboard",
...
export function buildProfileMetadata(profile, username) {
  ...
  return buildPageMetadata({
    ...
    description,
    ogType: "profile",
    ogImage: profile?.avatar_url || buildOgImageUrl({ title: displayName, subtitle: `Verifizierter ${rankLabel}` }),
  });
}
...
export const RANK_FAQS = [
  ...
  },
  {
    ...
    answer:
      "Ab Builder kannst du dich als Mentor bewerben. Stundensätze sind je nach Rang gedeckelt: Builder max. 50 EUR, Scaler max. 150 EUR, Elite max. 500 EUR.",
  },
];
