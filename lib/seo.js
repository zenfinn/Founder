...
export const PAGE_SEO = {
  ...
  community: {
    ...
    description:
      "Real Estate, E-Commerce, Web Design, Traditional Services und mehr – native Gruppen mit Chat, Tools und Wins für verifizierte Gründer.",
  },
  events: {
    path: "/events",
    title: "Meetups planen | Founder-Treffen organisieren",
    description:
      "Plane Founder-Meetups: Ort, Datum, Host-Infos und Beschreibung. Nach Freigabe sichtbar für alle Mitglieder der Community.",
  },
  onboarding: {
    path: "/onboarding/founder",
    title: "Founder AI – Dein persönlicher Community-Start",
    description:
      "Sag Hi Founder, beantworte vier Fragen per Text oder Sprache und erhalte dein persönliches Community-Podium mit den besten Gruppen für dich.",
  },
  jarvis: {
    path: "/jarvis",
    title: "Jarvis – Dein Founder AI Assistent",
    description:
      "Sprich mit Founder Jarvis per Kugel oder Text — persönliche Nischen-Empfehlungen und Community-Tipps jederzeit.",
  },
  mentoren: {
    path: "/mentoren",
...
export const RANK_FAQS = [
  ...
  },
  {
    ...
    answer:
      "Die Basis-Mitgliedschaft ist kostenlos. Founder Pro (14,99 EUR/Monat) ist optional für Premium-Tools, unbegrenzte Community-Beitritte und die Pro Lounge.",
  },
  {
