...
function buildExperienceAckReply(profile = {}, { aboutSelf = true, ready = false } = {}) {
  ...
  if (ready) {
    return aboutSelf
      ? name
        ? `${name}, verstanden — ${summary}${topicPart}. Tippe unten auf „Meine Top-Nischen“ für dein Ranking.`
        : `Verstanden — ${summary}${topicPart}. Tippe unten auf „Meine Top-Nischen“ für dein Ranking.`
      : name
        ? `Verstanden — ${name} ${summary}${topicPart}. Tippe unten auf „Meine Top-Nischen“.`
        : `Verstanden — ${summary}${topicPart}. Tippe unten auf „Meine Top-Nischen“.`;
  }
